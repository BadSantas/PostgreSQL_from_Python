...
try:
    ...
    client_id1 = add_client(conn, 'John', 'Doe', 'john.doe@example.com', ['123456789', '987654321'])
    client_id2 = add_client(conn, 'Jane', 'Smith', 'jane.smith@example.com')

    add_phone(conn, client_id2, '555555555')

    change_client(conn, client_id1, first_name='Johnny', phones=['111111111', '222222222'])

    delete_phone(conn, client_id1, '111111111')

    delete_client(conn, client_id2)

    print(find_client(conn, first_name='Johnny'))
    print(find_client(conn, email='john.doe@example.com'))
    print(find_client(conn, phone='222222222'))
